"""
Скрипт для тестирования генерации демо-заявок с прямым импортом конфигурации
"""
import random
import logging
...
# Импортируем конфигурацию демо-заявок напрямую
from demo_config_direct import DEMO_REQUEST_TEMPLATES, DEMO_CLIENTS
